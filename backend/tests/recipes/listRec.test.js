...
describe('List recommended recipes test', () => {
  ...
  const create = async (recipe, token) => {
    return await request.post('/recipes/add')
      .send(recipe)
  ...
  test('Should return recipes that match user preferences', async done => {
    ...
    await create({
      ...
      footNote: [
        "use peeled shrimp",
        "be careful not to burn your house"
      ],
      difficulty: 2,
      mainImage: "https://firebasestorage.googleapis.com/v0/b/project-mkb.appspot.com/o/shrimp-alfredo2.jpg?alt=media&token=d202d3e6-9d73-41ed-a4c3-1490e455998e",
      images: [
